subroutine gracon_vel2d(gv_u, gv_v, F, u_array, v_array, i_cmpt_r1, j_cmpt_r1, i_cmpt_r2, j_cmpt_r2, nx, ny, vr1, vr2, weights)
implicit none
...
real(kind=8), dimension(nx,ny):: gv_u, gv_v, u_array, v_array
!Observations
